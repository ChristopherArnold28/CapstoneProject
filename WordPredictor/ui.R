  ...
  tabsetPanel(
      tabPanel("Application",
          mainPanel(
              ...
              column(width = 12, align = "center", h2("Three Next Word Predictions")),
              tags$style(type = 'text/css', '.col-sm-4{font-size: 25px;}'),
              tags$style('text/css', '#choice2{font-size: 20px;}'),
              tags$style('text/css', '#choice3{font-size: 20px;}'),
              fluidRow(
